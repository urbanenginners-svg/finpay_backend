...
export class CreatePaymentOrderMetadataDto {
  @ApiPropertyOptional({
    example: '97787476-18b4-476f-871a-cc0ad2112969',
    description: 'Defaults to order_id when omitted',
  })
  @IsOptional()
  @IsString()
  @MinLength(8)
  @MaxLength(80)
  forex_order_id?: string;
...
export class CreatePaymentOrderDto {
  @ApiProperty({
    example: '97787476-18b4-476f-871a-cc0ad2112969',
    description: 'Prithvi forex order id from initiate/complete',
  })
  @IsString()
  @MinLength(8)
  @MaxLength(80)
  ...
  @ApiPropertyOptional({ type: CreatePaymentOrderMetadataDto })
  @IsOptional()
  @IsObject()
  @ValidateNested()
  @Type(() => CreatePaymentOrderMetadataDto)
  metadata?: CreatePaymentOrderMetadataDto;
}
